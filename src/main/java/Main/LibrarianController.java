...
public class LibrarianController {
    ...
    private void setupTables() {
        // This is the key change: Instead of PropertyValueFactory, we use a callback
        // to manually get the data from your model classes (which use standard getters).
    ...
    public static class IssueRequest {
        ...
        public IssueRequest(String memberName, String memberId, String bookTitle, String bookId) {
            this.memberName = memberName; this.memberId = memberId; this.bookTitle = bookTitle; this.bookId = bookId;
        }
    ...
    public static class ReturnRequest {
        ...
        public ReturnRequest(String memberName, String memberId, String bookTitle, String bookId, Double rating) {
            this.memberName = memberName; this.memberId = memberId; this.bookTitle = bookTitle; this.bookId = bookId; this.rating = rating;
        }
        public String getMemberName() { return memberName; }
        public String getMemberId() { return memberId; }
        public String getBookTitle() { return bookTitle; }
    ...
    public static class PublishRequest {
        ...
        public PublishRequest(String authorName, String authorId, String bookTitle, String bookId) {
            this.authorName = authorName; this.authorId = authorId; this.bookTitle = bookTitle; this.bookId = bookId;
        }
